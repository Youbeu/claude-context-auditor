...
export class AnomalyDetector {
    ...
    static analyze(bundle, options = {}) {
        ...
        const monthlyWasteAtEstimatedUsage = CostCalculator.calculateMonthlyCost(totalContextBeforeConversation, sessionsPerDay, workingDays, model);
        ...
        const potentialMonthlySavings = CostCalculator.calculateMonthlyCost(optimizableTokens, sessionsPerDay, workingDays, model);
