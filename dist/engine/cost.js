...
export class CostCalculator {
     ...
     */
    static calculateSessionCost(tokens, model = 'claude-3-7-sonnet') {
     ...
     */
    static calculateMonthlyCost(tokensOverhead, sessionsPerDay = 20, workingDays = 22, model = 'claude-3-7-sonnet') {
        const pricing = PRICING_TABLE[model] || PRICING_TABLE['claude-3-7-sonnet'];
