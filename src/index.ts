...
import { AnomalyDetector, DetectorOptions } from './engine/detector.js';
 ...
 */
export function auditContext(customConfigPath?: string, options?: DetectorOptions): AuditResult {
